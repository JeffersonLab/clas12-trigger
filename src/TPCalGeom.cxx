...
// The EC Geometry properties are taken from the PCal Geometry note, accesible
...
const double TPCalGeom::fy0_U = TPCalGeom::fyh - 85. * TPCalGeom::fdU; // Y coordinate of the Shortest U strip
const double TPCalGeom::fx0_V = TPCalGeom::fxl - 77. * TPCalGeom::fdV / sin(alpha_base); // X coordinate of the Shortest V strip 
const double TPCalGeom::fx0_W = TPCalGeom::fxr + 77. * TPCalGeom::fdW / sin(alpha_base); // X coordinate of the Shortest W strip 
const double TPCalGeom::fz0 = 764.1995467; // It is calculated as 6926/cos(25*TMath::DegToRad())
const double TPCalGeom::fyShift = 322.9646840; // It is calculated as 6926*tan(25*TMath::DegToRad())

TPCalGeom::TPCalGeom(double aU, double aV, double aW) // aU, aV, and aW represent readout channel index
{
