...
map<int, int> TECTrig::EC_vtp_sector = {
    ...
    {60092, 7}, // CND
    // ================= Data ==============
    {113, 0},     {114, 1},     {115, 2},     {116, 3},     {117, 4},     {118, 5},
...
map<int, int> TECTrig::EC_vtp_Detector = {
    ...
    {93, 4}, // HTCC, CTOF
    {92, 5}, // CND
    {113, 6},     {114, 6},     {115, 6},     {116, 6},     {117, 6},     {118, 6}  // DC Region3
};
...
void TECTrig::SetevioDOMENodeSect(evio::evioDOMNode* it, int a_adcECvtp_tag) {
    ...
    fnPCalU_Masks = fv_PCalUMasks.size();
...
T1DMask* TECTrig::GetPCalUMask(int aind) {
    ...
    if (fDet != 6 || fDet != 2) {
        cout << "Requesting for PCalU mask, but this seems, is not PCalU VTP data, " << endl;
        cout << "Exiting" << endl;
        exit(1);
    }

    return &fv_PCalUMasks.at(aind);
}

T1DMask* TECTrig::GetHTCCMask(int aind) {
...
T1DMask* TECTrig::GetFTOFMask(int aind) {
...
T1DMask* TECTrig::GetCTOFMask(int aind) {
