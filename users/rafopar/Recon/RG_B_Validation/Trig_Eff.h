...
// Fri Oct  5 06:45:56 2018 by ROOT version 6.10/02
// from TChain Trig_Eff/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<long>    *REC_Cherenkov_nphe;
   ...
   vector<long>    *RAW_vtp_slot;
   vector<long>    *RAW_vtp_channel;
   ...
   Trig_Eff( int arun, TTree *tree=0);
   virtual ~Trig_Eff();
...
#ifdef Trig_Eff_cxx
Trig_Eff::Trig_Eff( int arun, TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     ...
     frun = arun; 
      ...
      f->GetObject("Trig_Eff",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("Trig_Eff","");
      chain->Add(Form("Data/skim_%d_merged1.root/hipo2root", frun));
      //chain->Add("../Data/skim_em_4878.root/hipo2root");
      tree = chain;
#endif // SINGLE_TREE
