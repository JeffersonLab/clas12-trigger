...
// Wed Feb 13 23:00:34 2019 by ROOT version 6.16/00
// from TChain DC_Roads_check/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<long>    *REC_TrackCross_index;
   vector<long>    *REC_TrackCross_pindex;
   vector<long>    *REC_TrackCross_detector;
   vector<long>    *REC_TrackCross_sector;
   vector<long>    *REC_TrackCross_layer;
   vector<long>    *REC_TrackCross_status;
   vector<float>   *REC_TrackCross_c_x;
   vector<float>   *REC_TrackCross_c_y;
   vector<float>   *REC_TrackCross_c_z;
   vector<float>   *REC_TrackCross_c_ux;
   vector<float>   *REC_TrackCross_c_uy;
   vector<float>   *REC_TrackCross_c_uz;
   vector<long>    *FTOF_rawhits_id;
   vector<long>    *FTOF_rawhits_status;
   vector<long>    *FTOF_rawhits_sector;
   vector<long>    *FTOF_rawhits_layer;
   vector<long>    *FTOF_rawhits_component;
   vector<float>   *FTOF_rawhits_energy_left;
   vector<float>   *FTOF_rawhits_energy_right;
   vector<float>   *FTOF_rawhits_time_left;
   vector<float>   *FTOF_rawhits_time_right;
   vector<float>   *FTOF_rawhits_energy_left_unc;
   vector<float>   *FTOF_rawhits_energy_right_unc;
   vector<float>   *FTOF_rawhits_time_left_unc;
   vector<float>   *FTOF_rawhits_time_right_unc;
   ...
   vector<long>    *FTOF_clusters_id;
   vector<long>    *FTOF_clusters_status;
   vector<long>    *FTOF_clusters_trackid;
   vector<long>    *FTOF_clusters_sector;
   vector<long>    *FTOF_clusters_layer;
   vector<long>    *FTOF_clusters_component;
   vector<float>   *FTOF_clusters_energy;
   vector<float>   *FTOF_clusters_time;
   vector<float>   *FTOF_clusters_energy_unc;
   vector<float>   *FTOF_clusters_time_unc;
   vector<float>   *FTOF_clusters_x;
   vector<float>   *FTOF_clusters_y;
   vector<float>   *FTOF_clusters_z;
   vector<float>   *FTOF_clusters_x_unc;
   vector<float>   *FTOF_clusters_y_unc;
   vector<float>   *FTOF_clusters_z_unc;
   vector<long>    *FTOF_matchedclusters_sector;
   vector<long>    *FTOF_matchedclusters_paddle_id1A;
   vector<long>    *FTOF_matchedclusters_paddle_id1B;
   vector<long>    *FTOF_matchedclusters_clus_1Aid;
   vector<long>    *FTOF_matchedclusters_clus_1Bid;
   vector<long>    *FTOF_matchedclusters_clusSize_1A;
   vector<long>    *FTOF_matchedclusters_clusSize_1B;
   vector<float>   *FTOF_matchedclusters_tminAlgo_1B_tCorr;
   vector<float>   *FTOF_matchedclusters_midbarAlgo_1B_tCorr;
   vector<float>   *FTOF_matchedclusters_EmaxAlgo_1B_tCorr;
   vector<long>    *CTOF_rawhits_id;
   vector<long>    *CTOF_rawhits_status;
   vector<long>    *CTOF_rawhits_component;
   vector<float>   *CTOF_rawhits_energy_up;
   vector<float>   *CTOF_rawhits_energy_down;
   vector<float>   *CTOF_rawhits_time_up;
   vector<float>   *CTOF_rawhits_time_down;
   vector<float>   *CTOF_rawhits_energy_up_unc;
   vector<float>   *CTOF_rawhits_energy_down_unc;
   vector<float>   *CTOF_rawhits_time_up_unc;
   vector<float>   *CTOF_rawhits_time_down_unc;
   ...
   vector<long>    *ECAL_adc_sector;
   vector<long>    *ECAL_adc_layer;
   vector<long>    *ECAL_adc_component;
   vector<long>    *ECAL_adc_order;
   vector<long>    *ECAL_adc_ADC;
   vector<long>    *ECAL_adc_ped;
   vector<float>   *ECAL_adc_time;
   ...
   TBranch        *b_REC_TrackCross_index;   //!
   TBranch        *b_REC_TrackCross_pindex;   //!
   TBranch        *b_REC_TrackCross_detector;   //!
   TBranch        *b_REC_TrackCross_sector;   //!
   TBranch        *b_REC_TrackCross_layer;   //!
   TBranch        *b_REC_TrackCross_status;   //!
   TBranch        *b_REC_TrackCross_c_x;   //!
   TBranch        *b_REC_TrackCross_c_y;   //!
   TBranch        *b_REC_TrackCross_c_z;   //!
   TBranch        *b_REC_TrackCross_c_ux;   //!
   TBranch        *b_REC_TrackCross_c_uy;   //!
   TBranch        *b_REC_TrackCross_c_uz;   //!
   TBranch        *b_FTOF_rawhits_id;   //!
   TBranch        *b_FTOF_rawhits_status;   //!
   TBranch        *b_FTOF_rawhits_sector;   //!
   TBranch        *b_FTOF_rawhits_layer;   //!
   TBranch        *b_FTOF_rawhits_component;   //!
   TBranch        *b_FTOF_rawhits_energy_left;   //!
   TBranch        *b_FTOF_rawhits_energy_right;   //!
   TBranch        *b_FTOF_rawhits_time_left;   //!
   TBranch        *b_FTOF_rawhits_time_right;   //!
   TBranch        *b_FTOF_rawhits_energy_left_unc;   //!
   TBranch        *b_FTOF_rawhits_energy_right_unc;   //!
   TBranch        *b_FTOF_rawhits_time_left_unc;   //!
   TBranch        *b_FTOF_rawhits_time_right_unc;   //!
   ...
   TBranch        *b_FTOF_matchedclusters_sector;   //!
   TBranch        *b_FTOF_matchedclusters_paddle_id1A;   //!
   TBranch        *b_FTOF_matchedclusters_paddle_id1B;   //!
   TBranch        *b_FTOF_matchedclusters_clus_1Aid;   //!
   TBranch        *b_FTOF_matchedclusters_clus_1Bid;   //!
   TBranch        *b_FTOF_matchedclusters_clusSize_1A;   //!
   TBranch        *b_FTOF_matchedclusters_clusSize_1B;   //!
   TBranch        *b_FTOF_matchedclusters_tminAlgo_1B_tCorr;   //!
   TBranch        *b_FTOF_matchedclusters_midbarAlgo_1B_tCorr;   //!
   TBranch        *b_FTOF_matchedclusters_EmaxAlgo_1B_tCorr;   //!
   TBranch        *b_CTOF_rawhits_id;   //!
   TBranch        *b_CTOF_rawhits_status;   //!
   TBranch        *b_CTOF_rawhits_component;   //!
   TBranch        *b_CTOF_rawhits_energy_up;   //!
   TBranch        *b_CTOF_rawhits_energy_down;   //!
   TBranch        *b_CTOF_rawhits_time_up;   //!
   TBranch        *b_CTOF_rawhits_time_down;   //!
   TBranch        *b_CTOF_rawhits_energy_up_unc;   //!
   TBranch        *b_CTOF_rawhits_energy_down_unc;   //!
   TBranch        *b_CTOF_rawhits_time_up_unc;   //!
   TBranch        *b_CTOF_rawhits_time_down_unc;   //!
   ...
   TBranch        *b_ECAL_adc_sector;   //!
   TBranch        *b_ECAL_adc_layer;   //!
   TBranch        *b_ECAL_adc_component;   //!
   TBranch        *b_ECAL_adc_order;   //!
   TBranch        *b_ECAL_adc_ADC;   //!
   TBranch        *b_ECAL_adc_ped;   //!
   TBranch        *b_ECAL_adc_time;   //!
   ...
   DC_Roads_check(int, TTree *tree=0);
   virtual ~DC_Roads_check();
...
#ifdef DC_Roads_check_cxx
DC_Roads_check::DC_Roads_check(int arun, TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("DC_Roads_check",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("DC_Roads_check","");
      chain->Add(Form("Data/mon_clas_00%d.evio.*.root/hipo2root", frun));
      //chain->Add("Data/mon_clas_006202.evio.00100.root/hipo2root");
      tree = chain;
#endif // SINGLE_TREE
...
DC_Roads_check::~DC_Roads_check()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DC_Roads_check::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DC_Roads_check::LoadTree(Long64_t entry)
{
...
void DC_Roads_check::Init(TTree *tree)
{
   ...
   REC_TrackCross_index = 0;
   REC_TrackCross_pindex = 0;
   REC_TrackCross_detector = 0;
   REC_TrackCross_sector = 0;
   REC_TrackCross_layer = 0;
   REC_TrackCross_status = 0;
   REC_TrackCross_c_x = 0;
   REC_TrackCross_c_y = 0;
   REC_TrackCross_c_z = 0;
   REC_TrackCross_c_ux = 0;
   REC_TrackCross_c_uy = 0;
   REC_TrackCross_c_uz = 0;
   FTOF_rawhits_id = 0;
   FTOF_rawhits_status = 0;
   FTOF_rawhits_sector = 0;
   FTOF_rawhits_layer = 0;
   FTOF_rawhits_component = 0;
   FTOF_rawhits_energy_left = 0;
   FTOF_rawhits_energy_right = 0;
   FTOF_rawhits_time_left = 0;
   FTOF_rawhits_time_right = 0;
   FTOF_rawhits_energy_left_unc = 0;
   FTOF_rawhits_energy_right_unc = 0;
   FTOF_rawhits_time_left_unc = 0;
   FTOF_rawhits_time_right_unc = 0;
   FTOF_hits_id = 0;
   FTOF_hits_status = 0;
   FTOF_hits_trackid = 0;
   FTOF_hits_sector = 0;
   ...
   FTOF_matchedclusters_sector = 0;
   FTOF_matchedclusters_paddle_id1A = 0;
   FTOF_matchedclusters_paddle_id1B = 0;
   FTOF_matchedclusters_clus_1Aid = 0;
   FTOF_matchedclusters_clus_1Bid = 0;
   FTOF_matchedclusters_clusSize_1A = 0;
   FTOF_matchedclusters_clusSize_1B = 0;
   FTOF_matchedclusters_tminAlgo_1B_tCorr = 0;
   FTOF_matchedclusters_midbarAlgo_1B_tCorr = 0;
   FTOF_matchedclusters_EmaxAlgo_1B_tCorr = 0;
   CTOF_rawhits_id = 0;
   CTOF_rawhits_status = 0;
   CTOF_rawhits_component = 0;
   CTOF_rawhits_energy_up = 0;
   CTOF_rawhits_energy_down = 0;
   CTOF_rawhits_time_up = 0;
   CTOF_rawhits_time_down = 0;
   CTOF_rawhits_energy_up_unc = 0;
   CTOF_rawhits_energy_down_unc = 0;
   CTOF_rawhits_time_up_unc = 0;
   CTOF_rawhits_time_down_unc = 0;
   CTOF_hits_id = 0;
   CTOF_hits_status = 0;
   CTOF_hits_trkID = 0;
   CTOF_hits_sector = 0;
   ...
   fChain->SetBranchAddress("REC_TrackCross_index", &REC_TrackCross_index, &b_REC_TrackCross_index);
   fChain->SetBranchAddress("REC_TrackCross_pindex", &REC_TrackCross_pindex, &b_REC_TrackCross_pindex);
   fChain->SetBranchAddress("REC_TrackCross_detector", &REC_TrackCross_detector, &b_REC_TrackCross_detector);
   fChain->SetBranchAddress("REC_TrackCross_sector", &REC_TrackCross_sector, &b_REC_TrackCross_sector);
   fChain->SetBranchAddress("REC_TrackCross_layer", &REC_TrackCross_layer, &b_REC_TrackCross_layer);
   fChain->SetBranchAddress("REC_TrackCross_status", &REC_TrackCross_status, &b_REC_TrackCross_status);
   fChain->SetBranchAddress("REC_TrackCross_c_x", &REC_TrackCross_c_x, &b_REC_TrackCross_c_x);
   fChain->SetBranchAddress("REC_TrackCross_c_y", &REC_TrackCross_c_y, &b_REC_TrackCross_c_y);
   fChain->SetBranchAddress("REC_TrackCross_c_z", &REC_TrackCross_c_z, &b_REC_TrackCross_c_z);
   fChain->SetBranchAddress("REC_TrackCross_c_ux", &REC_TrackCross_c_ux, &b_REC_TrackCross_c_ux);
   fChain->SetBranchAddress("REC_TrackCross_c_uy", &REC_TrackCross_c_uy, &b_REC_TrackCross_c_uy);
   fChain->SetBranchAddress("REC_TrackCross_c_uz", &REC_TrackCross_c_uz, &b_REC_TrackCross_c_uz);
   fChain->SetBranchAddress("FTOF_rawhits_id", &FTOF_rawhits_id, &b_FTOF_rawhits_id);
   fChain->SetBranchAddress("FTOF_rawhits_status", &FTOF_rawhits_status, &b_FTOF_rawhits_status);
   fChain->SetBranchAddress("FTOF_rawhits_sector", &FTOF_rawhits_sector, &b_FTOF_rawhits_sector);
   fChain->SetBranchAddress("FTOF_rawhits_layer", &FTOF_rawhits_layer, &b_FTOF_rawhits_layer);
   fChain->SetBranchAddress("FTOF_rawhits_component", &FTOF_rawhits_component, &b_FTOF_rawhits_component);
   fChain->SetBranchAddress("FTOF_rawhits_energy_left", &FTOF_rawhits_energy_left, &b_FTOF_rawhits_energy_left);
   fChain->SetBranchAddress("FTOF_rawhits_energy_right", &FTOF_rawhits_energy_right, &b_FTOF_rawhits_energy_right);
   fChain->SetBranchAddress("FTOF_rawhits_time_left", &FTOF_rawhits_time_left, &b_FTOF_rawhits_time_left);
   fChain->SetBranchAddress("FTOF_rawhits_time_right", &FTOF_rawhits_time_right, &b_FTOF_rawhits_time_right);
   fChain->SetBranchAddress("FTOF_rawhits_energy_left_unc", &FTOF_rawhits_energy_left_unc, &b_FTOF_rawhits_energy_left_unc);
   fChain->SetBranchAddress("FTOF_rawhits_energy_right_unc", &FTOF_rawhits_energy_right_unc, &b_FTOF_rawhits_energy_right_unc);
   fChain->SetBranchAddress("FTOF_rawhits_time_left_unc", &FTOF_rawhits_time_left_unc, &b_FTOF_rawhits_time_left_unc);
   fChain->SetBranchAddress("FTOF_rawhits_time_right_unc", &FTOF_rawhits_time_right_unc, &b_FTOF_rawhits_time_right_unc);
   ...
   fChain->SetBranchAddress("FTOF_matchedclusters_sector", &FTOF_matchedclusters_sector, &b_FTOF_matchedclusters_sector);
   fChain->SetBranchAddress("FTOF_matchedclusters_paddle_id1A", &FTOF_matchedclusters_paddle_id1A, &b_FTOF_matchedclusters_paddle_id1A);
   fChain->SetBranchAddress("FTOF_matchedclusters_paddle_id1B", &FTOF_matchedclusters_paddle_id1B, &b_FTOF_matchedclusters_paddle_id1B);
   fChain->SetBranchAddress("FTOF_matchedclusters_clus_1Aid", &FTOF_matchedclusters_clus_1Aid, &b_FTOF_matchedclusters_clus_1Aid);
   fChain->SetBranchAddress("FTOF_matchedclusters_clus_1Bid", &FTOF_matchedclusters_clus_1Bid, &b_FTOF_matchedclusters_clus_1Bid);
   fChain->SetBranchAddress("FTOF_matchedclusters_clusSize_1A", &FTOF_matchedclusters_clusSize_1A, &b_FTOF_matchedclusters_clusSize_1A);
   fChain->SetBranchAddress("FTOF_matchedclusters_clusSize_1B", &FTOF_matchedclusters_clusSize_1B, &b_FTOF_matchedclusters_clusSize_1B);
   fChain->SetBranchAddress("FTOF_matchedclusters_tminAlgo_1B_tCorr", &FTOF_matchedclusters_tminAlgo_1B_tCorr, &b_FTOF_matchedclusters_tminAlgo_1B_tCorr);
   fChain->SetBranchAddress("FTOF_matchedclusters_midbarAlgo_1B_tCorr", &FTOF_matchedclusters_midbarAlgo_1B_tCorr, &b_FTOF_matchedclusters_midbarAlgo_1B_tCorr);
   fChain->SetBranchAddress("FTOF_matchedclusters_EmaxAlgo_1B_tCorr", &FTOF_matchedclusters_EmaxAlgo_1B_tCorr, &b_FTOF_matchedclusters_EmaxAlgo_1B_tCorr);
   fChain->SetBranchAddress("CTOF_rawhits_id", &CTOF_rawhits_id, &b_CTOF_rawhits_id);
   fChain->SetBranchAddress("CTOF_rawhits_status", &CTOF_rawhits_status, &b_CTOF_rawhits_status);
   fChain->SetBranchAddress("CTOF_rawhits_component", &CTOF_rawhits_component, &b_CTOF_rawhits_component);
   fChain->SetBranchAddress("CTOF_rawhits_energy_up", &CTOF_rawhits_energy_up, &b_CTOF_rawhits_energy_up);
   fChain->SetBranchAddress("CTOF_rawhits_energy_down", &CTOF_rawhits_energy_down, &b_CTOF_rawhits_energy_down);
   fChain->SetBranchAddress("CTOF_rawhits_time_up", &CTOF_rawhits_time_up, &b_CTOF_rawhits_time_up);
   fChain->SetBranchAddress("CTOF_rawhits_time_down", &CTOF_rawhits_time_down, &b_CTOF_rawhits_time_down);
   fChain->SetBranchAddress("CTOF_rawhits_energy_up_unc", &CTOF_rawhits_energy_up_unc, &b_CTOF_rawhits_energy_up_unc);
   fChain->SetBranchAddress("CTOF_rawhits_energy_down_unc", &CTOF_rawhits_energy_down_unc, &b_CTOF_rawhits_energy_down_unc);
   fChain->SetBranchAddress("CTOF_rawhits_time_up_unc", &CTOF_rawhits_time_up_unc, &b_CTOF_rawhits_time_up_unc);
   fChain->SetBranchAddress("CTOF_rawhits_time_down_unc", &CTOF_rawhits_time_down_unc, &b_CTOF_rawhits_time_down_unc);
   ...
   fChain->SetBranchAddress("ECAL_adc_sector", &ECAL_adc_sector, &b_ECAL_adc_sector);
   fChain->SetBranchAddress("ECAL_adc_layer", &ECAL_adc_layer, &b_ECAL_adc_layer);
   fChain->SetBranchAddress("ECAL_adc_component", &ECAL_adc_component, &b_ECAL_adc_component);
   fChain->SetBranchAddress("ECAL_adc_order", &ECAL_adc_order, &b_ECAL_adc_order);
   fChain->SetBranchAddress("ECAL_adc_ADC", &ECAL_adc_ADC, &b_ECAL_adc_ADC);
   fChain->SetBranchAddress("ECAL_adc_ped", &ECAL_adc_ped, &b_ECAL_adc_ped);
   fChain->SetBranchAddress("ECAL_adc_time", &ECAL_adc_time, &b_ECAL_adc_time);
...
void DC_Roads_check::Show(Long64_t entry)
{
...
Int_t DC_Roads_check::Cut(Long64_t entry)
{
...
#endif // #ifdef DC_Roads_check_cxx
