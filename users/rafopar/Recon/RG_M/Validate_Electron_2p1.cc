...
int main(int argc, char** argv) {
    ...
    const double ESum_Threshold = 0.1;
    const double ESum_AboveThresholdCut = 0.15;
    ...
    TFile *file_out = new TFile("Validate_Electron_2p1.root", "Recreate");
        ...
        while (reader.next() == true) {
            ...
            for (int i_part = 0; i_part < nPart; i_part++) {
                ...
                for (int i_vtp = 0; i_vtp < v_vtp_time.size(); i_vtp++) {
                    ...
                    bool em_tot_trig = v_vtp_trbit.at(i_vtp)(7, 7);
                    bool em_sect_trig = v_vtp_trbit.at(i_vtp)(8, 13);
                    bool em_DC_inbend_trig = v_vtp_trbit.at(i_vtp)(1, 6);
                    int em_sect_trig_int = v_vtp_trbit.at(i_vtp)(8, 13);

                    for (int iS = 0; iS < n_sect; iS++) {

                        if (v_vtp_trbit.at(i_vtp)(iS + 8, iS + 8)) {
